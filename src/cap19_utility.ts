...
console.log(permuteRows(addFullName, [{ first: "Tapioca", last: "Kito" }]));
...
console.log(createObjects(PersonWithFullName, [{ first: "Tapio", last: "Kito" }]));
